...
const Terms = () => {
  return (
    <Layout>
      <SEO
        title="Terms of Use"
        description="Read the terms of use for {{PROJECT_NAME}} and learn about the conditions for using our finance portal."
      />
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            <p className="body-lg text-muted-foreground">
              Welcome to {"{{PROJECT_NAME}}"}. By accessing and using our site {"{{DOMAIN}}"}, you agree
          ...
          <section>
            ...
            <p className="body-md text-muted-foreground">
              By accessing or using {"{{PROJECT_NAME}}"}, you confirm that you have read, understood and agree to
          ...
          <section>
            ...
            <p className="body-md text-muted-foreground mb-4">
              {"{{PROJECT_NAME}}"} is an informational content portal about finance, investments,
          ...
          <section>
            ...
            <p className="body-md text-muted-foreground mb-4">
              <strong>IMPORTANT:</strong> The content published on {"{{PROJECT_NAME}}"} is
          ...
          <section>
            ...
            <p className="body-md text-muted-foreground mb-4">
              All content on {"{{PROJECT_NAME}}"}, including texts, graphics, logos, icons,
              images and software, is the exclusive property of {"{{PROJECT_NAME}}"} or its
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              <li>Agree to receive email communications from {"{{PROJECT_NAME}}"}</li>
          ...
          <section>
            ...
            <p className="body-md text-muted-foreground">
              {"{{PROJECT_NAME}}"} displays third-party advertisements to fund its operations.
          ...
          <section>
            ...
            <p className="body-md text-muted-foreground">
              To the maximum extent permitted by law, {"{{PROJECT_NAME}}"} will not be liable for
